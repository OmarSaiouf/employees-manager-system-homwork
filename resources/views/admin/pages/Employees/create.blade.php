            ...
            <form action="{{ route('employee.store') }}" method="POST">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputFirstName1" name="first_name" value="{{ old('first_name') }}" required />
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputLastName1" class="form-label">Last Name</label>
                        <input type="text" class="form-control" id="exampleInputLastName1" name="last_name" value="{{ old('last_name') }}" required />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputCity1" name="city" value="{{ old('city') }}" />
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputDepartment1" class="form-label">Department</label>
                        <input type="text" class="form-control" id="exampleInputDepartment1" name="department" value="{{ old('department') }}" />
                    </div>

                    <div class="mb-3">
                        <label for="exampleInputDescription1" class="form-label">Description</label>
                        <textarea class="form-control" id="exampleInputDescription1" name="description">{{ old('description') }}</textarea>
                    </div>
